...
num_brake_levels = 5
max_brake = 1
action_values_brake = np.linspace(0, max_brake, num_brake_levels + 1)
# Crea intervalli regolari escludendo lo 0
action_map_brake = {i: x for i, x in enumerate(action_values_brake)}

# Definizione dei valori di azione dell'acceleratore
num_throttle_levels = 0
max_throttle = 0.75
action_values_throttle = [0.25, 0.5, 0.75, 1]
