...
class ConvNet(nn.Module):
    def __init__(self, in_channels, num_actions_steer, num_actions_throttle) -> None:
        ...
        self.fc1 = nn.Linear(64 * 8 * 8, 512)  # Aumenta il numero di unità
        self.fc1_bn = nn.BatchNorm1d(512)
        self.fc2 = nn.Linear(512, 128)  # Aumenta il numero di unità
        self.fc2_bn = nn.BatchNorm1d(128)
        self.fc3_steer = nn.Linear(128, num_actions_steer)
        self.fc3_throttle = nn.Linear(128, num_actions_throttle)
...
class DQN(object):
    def __init__(
            ...
            target_update_frequency=1000,  # Aggiornamento più frequente
            initial_eps=1,
            end_eps=0.1,
        ...
        if optimizer_parameters is None:
            optimizer_parameters = {'lr': 1e-4}  # Abbassa il learning rate
        self.device = device
    ...
    def train(self, replay_buffer):
        ...
        # Bilancia le due perdite se necessario
        total_loss = Q_loss_steer + Q_loss_throttle
